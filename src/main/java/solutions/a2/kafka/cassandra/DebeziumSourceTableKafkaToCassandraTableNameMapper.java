 ...
 * 
 */
public class DebeziumSourceTableKafkaToCassandraTableNameMapper implements KafkaToCassandraTableNameMapper {

	private static final Logger LOGGER = LoggerFactory.getLogger(DebeziumSourceTableKafkaToCassandraTableNameMapper.class);
	...
	public String getTableName(final SinkRecord record, final int schemaType) {
		...
		if (schemaType == ParamConstants.SCHEMA_TYPE_INT_KEY_VALUE ||
			...
			LOGGER.debug("Table name from Debezium messaage  = '{}'.", tableName);
		}
		return tableName;
	}
